...
println("\n\t\t===== Stochastic OPF: 30 Bus case, 10 Uncertainties, Sparse PCE =====\n")
...
# PCE coefficients
f_coeff = "coefficients/SOPF_10u_sparse.jld2"
...
f_moms = "coefficients/SOPF_10u_sparse_moments.jld2"
...
if postProcessing
    ...
    plotHistogram_2unc(pf_samples[:pd], pf_samples[:qd], ["pd_8", "qd_8", "pg_13", "qg_13"], "./plots/10u_sparse"; fignum=0 + 10, color=mycolor)
end
